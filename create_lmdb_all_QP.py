...
target_path = '/home/ayanisizeco/STDF-PyTorch/Dataset/MFQEv2_dataset/TrainData_LMDB/QP_37_27_17'
...
def create_lmdb_for_mfqev2():
    ...
    lq_folder = [lq_folder]
    lq_folder.append('train_108/HM16.5_LDP/QP17')
    lq_folder.append('train_108/HM16.5_LDP/QP27')
    lq_dir = []
    lq_dir.append(op.join(root_dir, lq_folder[0]))
    lq_dir.append(op.join(root_dir, lq_folder[1]))
    lq_dir.append(op.join(root_dir, lq_folder[2]))
    # lq_dir = [op.join(root_dir, lq_folder), op.join(root_dir, lq_folder), op.join(root_dir, lq_folder)]
    ...
    ) for lq_dir_x in lq_dir for gt_video_path in gt_video_list ]
    gt_video_list = gt_video_list*3
